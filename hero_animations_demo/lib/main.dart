...
import 'package:hero_animations_demo/details.dart';
        ...
        child: Row(
          children: <Widget>[
            GestureDetector(
              ...
              onTap: () {
                changeRoute(context, Drinks.coffee);
              },
            ),
            GestureDetector(
              child: Util.buildHeroRadialIcon(
              ...
              onTap: () {
                changeRoute(context, Drinks.cappuccino);
              },
            ),
            GestureDetector(
              child: Util.buildHeroRadialIcon(
              ...
              onTap: () {
                changeRoute(context, Drinks.tea);
              },
            ),
          ],
    ...
    switch (drink) {
      case Drinks.coffee:
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => Details(Util.COFFEE_URL, 'coffee')));
        break;
      case Drinks.cappuccino:
        Navigator.push(
            ...
            MaterialPageRoute(
                builder: (context) =>
                    Details(Util.CAPPUCCINO_URL, 'cappuccino')));
        break;
      case Drinks.tea:
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => Details(Util.TEA_URL, 'tea')));
        break;
    }
  }
}
